...
<div class="container-fluid mt-4">
  ...
  <div class="d-flex align-items-center mb-3">
    ...
    <!-- Botón Nuevo Usuario -->
    <a href="?controller=user&action=create" class="btn btn-primary me-3">
    ...
    <div class="input-group ms-auto" style="max-width:320px;">
      ...
      >
      <!-- Botón Buscar -->
      <button class="btn btn-success" id="btnSearchUser">
    ...
    <table class="table table-hover align-middle mb-0">
      ...
      <tbody>
        ...
        <tr>
          <!-- Foto predeterminada -->
          <td>
            <img src="assets/img/person-circle.png" alt="Foto" width="24">
          </td>
          <!-- Rol -->
          ...
          <td class="text-center">
            <a
              href="?controller=user&action=edit&id=<?= $u['id'] ?>"
            ...
            <a
              href="?controller=user&action=delete&id=<?= $u['id'] ?>"
